...
Route::prefix('/v1')->group(function () {
    ...
    Route::get('permissions', [PermissionsController::class, 'getPermissionList']); // Implemented in frontend
    Route::post('permissions/store', [PermissionsController::class, 'savePermission']); // Implemented in frontend
    Route::put('permissions/update/{permission}', [PermissionsController::class, 'updatePermission']); // Implemented in frontend
    Route::delete('permissions/delete/{id}', [PermissionsController::class, 'inactivatePermissionById']); // Implemented in frontend
